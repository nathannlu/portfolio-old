                        ...
                        <Row>
                            <Col md={6} className="mt-4 pt-2">
                                <div className="work-container position-relative d-block overflow-hidden rounded">
                                    ...
                                    <div className="content personal-port">
                                        <div to="page-work-detail" className="title text-white d-block font-weight-bold">Jack Chow Insurance</div>
                                        <small className="text-light">Branding, UI/UX, Web Development</small>
                                    </div>
                                </div>
                            </Col>
                            ...
                            <Col md={6} className="mt-4 pt-2">
                                <div className="work-container position-relative d-block overflow-hidden rounded">
                                    ...
                                    <div className="content personal-port">
                                        <div to="page-work-detail" className="title text-white d-block font-weight-bold">Ignited Future</div>
                            ...
                            <Col md={6} className="mt-4 pt-2">
                                <div className="work-container position-relative d-block overflow-hidden rounded">
                                    ...
                                    <div className="content personal-port">
                                        <div to="page-work-detail" className="title text-white d-block font-weight-bold">Shifting Perspective</div>
                        ...
                        <Row>
                            <Col>
                                <div className="section-title mb-4 pb-2">
                                    ...
                                    <p className="text-muted para-desc mb-0">I follow a simple process that streamlines complex processes. The way I work will be transparent to you as a client.</p>
                                </div>
                            </Col>
                        </Row>
                        ...
                        <Row>
                            <Col md={4} className="mt-4 pt-2" >
                                <div className="work-process p-lg-4 p-3 rounded shadow">
                                    ...
                                    <p className="text-muted para">During the initial phase of a project we take the time to get too know our clients to accurately determine their needs and current situation.</p>
                            ...
                            <Col md={4} className="mt-4 pt-2" >
                                <div className="work-process p-lg-4 p-3 rounded shadow">
                                    ...
                                    <p className="text-muted para">We will focus on the specifications you have provided and your business goals. Each design will be tailored to match your specific needs.</p>
                            ...
                            <Col md={4} className="mt-4 pt-2" >
                                <div className="work-process p-lg-4 p-3 rounded shadow">
                                    ...
                                    <p className="text-muted para">Once everything has been designed and developed to the point where you, as the client, are satisfied with it, we will launch the product or service.</p>
